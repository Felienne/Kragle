...
\item[RQ3] How are coding style conventions applied in Scratch?
\item[RQ4] Which code smells and bad programming practices are common in Scratch programs?
\end{itemize}
...
\textbf{RQ2} Which coding abstractions and programming concepts and features are commonly used when programming in the Scratch environment? Using the code in the dataset, we perform a detailed statistical analysis of code characteristics to answer RQ2 (Section ??)

\textbf{RQ3} How are coding style conventions applied in Scratch? to examine if coding style conventions are used, we qualitatively analyze..

\textbf{RQ4} Which code smells and bad programming practices are common in Scratch programs?
...
naming -functions, sprites, variables
positioning - overlapping /visibility	
